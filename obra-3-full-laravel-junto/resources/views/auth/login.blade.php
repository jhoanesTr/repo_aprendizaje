...
@section('content')
    ...
    <div id="login-container" class="form-signin d-flex justify-content-center p-5">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="row mb-0 mx-5">
                <button class="w-50 mx-5 btn btn-warning border-dark" type="submit">Iniciar</button>
