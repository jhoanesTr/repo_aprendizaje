    ...
    <div class="container mb-4">
        <nav class="navbar navbar-light my-4">
            <div class="container-fluid">
                <h3 class="text-secondary w-25"><b>PERSOAS</b></h3>
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr class="table-primary">
                        <th class="text-nowrap">@sortablelink('nome', 'Nome')</th>
                        <th class="text-nowrap">@sortablelink('primeiro_apelido', '1º Apelido')</th>
                        <th class="text-nowrap">@sortablelink('segundo_apelido', '2º Apelido')</th>
                        <th class="text-nowrap">@sortablelink('nif', 'DNI/NIF')</th>
                        <th class="text-nowrap">@sortablelink('data_nacemento', 'Nacemento')</th>
                        <th class="text-nowrap">@sortablelink('sexo', 'Sexo')</th>
                        <th class="text-nowrap">@sortablelink('codigo_postal', 'CP')</th>
                        <th class="text-nowrap">@sortablelink('telefono', 'Teléfono')</th>
                        <th class="text-nowrap">@sortablelink('email', 'Correo')</th>
                ...
                <tbody>
                    ...
                    @else
                        ...
                        {{-- METODO DE SARAI PARA QUE LA FILA LLEVE A LA FICHA --}}
                            <tr data-href="{{ route('persoas.show', $persoa->id) }}" style="cursor: pointer">
                                {{-- <td>{{ $persoa->id }}</td> --}}
                                <td>{{ $persoa->nome }}</td>
