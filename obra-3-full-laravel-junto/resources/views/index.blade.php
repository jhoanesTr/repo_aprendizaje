...
@section('content')
    ...
    <div class="container">
        ...
        <div class="p-3 m-1 text-secondary">
        ...
        <div class="card border-light">
            <div class="card-text p-3">
                ...
                @endif
                {{-- mensaje bienvenida --}}
                <h5>{{ auth()->user()->name }} iniciou sesión correctamente</h5>
            </div>

            {{-- <div class="card-body">
                <div class="panel-body">
                  <a href="{{route('admin.index')}}" class="btn btn-primary" aria-current="true">Acceder a Panel de Admin</a>
                </div>
            </div> --}}
        </div>
