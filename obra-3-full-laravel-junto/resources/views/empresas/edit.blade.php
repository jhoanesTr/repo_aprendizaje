                ...
                <div class="container">
                    ...
                    <form class="row g-3 mt-4" method="POST" action="{{ route('empresas.update', $empresas->id) }}" autocomplete="off">
                            ...
                            <div class="col-md-4 my-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="form-control" id="orientador" name="orientador"
                                        placeholder="" value="{{ $empresas->orientador }}" required>
                        ...
                        <div class="form-group ">
                            ...
                            <textarea class="form-control" id="notas" name="notas" rows="4" value="{{ $empresas->notas }}"></textarea>
                        </div>
