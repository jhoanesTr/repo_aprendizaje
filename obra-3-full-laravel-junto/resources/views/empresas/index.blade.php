    ...
    <div class="container mb-4">
        <nav class="navbar navbar-light my-4">
            <div class="container-fluid">
                <h3 class="text-secondary w-25" id="title"><b>EMPRESAS</b></h3>
            ...
            <table class="table table-striped table-hover">
                <thead>
                    <tr class="table-primary">
                        <th>@sortablelink('nome', 'Nome da Empresa')</th>
                        <th>@sortablelink('localidade', 'Localidade')</th>
                        {{-- <th>Actividade</th> --}}
                        <th>@sortablelink('telefono', 'Teléfono')</th>
                        {{-- <th>Fax</th> --}}
                        <th>@sortablelink('data_incorporacion', 'Data alta')</th>
                        <th>@sortablelink('persoa_contacto', 'Contacto')</th>
                        <th>@sortablelink('orientador', 'Orientador/a')</th>
                ...
                <tbody>
                    ...
                    @else
                        ...
                        @foreach ($empresas as $empresa)
                            <tr data-href="{{ route('empresas.show', $empresa->id) }}" style="cursor: pointer">
                                {{-- <td>{{ $empresa->id }}</td> --}}
                                <td>{{ $empresa->nome }}</td>
