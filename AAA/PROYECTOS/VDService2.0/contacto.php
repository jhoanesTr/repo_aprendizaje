...
<!--VERIFICAR-->        <div class="row row-cols-xl-3 row-cols-xs-2">
    ...
    <footer class="bg-secondary text-center text-white py-3 container-fluid">

    <!--Copyright-->
        <span class="p-0" id="copyright">
            © 2022 Copyright: JhoanesVD
        </span>
    ...
    <div class="container">
        ...
        <a href="" class=" btn p-0 rounded-circle">
            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-facebook text-secondary bg-white rounded-circle" viewBox="0 0 16 16">
