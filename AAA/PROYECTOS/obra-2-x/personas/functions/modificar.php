<?php
require dirname(__FILE__,3). "/functions/conexion2.php";
...
<body>
	<!-- MENU SUPERIOR -->
	<?php include dirname(__FILE__,3). "/components/header.php" ?>
	...
	<!-- FOOTER -->
	<?php include dirname(__FILE__,3). "/components/footer.php" ?>
	<!-- FOOTER -->
