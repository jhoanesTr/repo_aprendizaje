...
<head>
    ...
    <link rel="stylesheet" href="/obra-2-x/src/css/index-personas.css">
...
<div class="container">
		...
		<div class="row2">
			<div> <a href="./functions/nuevo.php" class="btn btn-primary">Novo Rexistro</a></div>
				...
				<tbody>
					<?php while ($row = $resultado->fetch_array(MYSQLI_ASSOC)) { ?>
						<tr>
							...
							<td><a href="./functions/eliminar.php?id=<?php echo $row['id']; ?>" data-toggle="modal" data-target="#confirm-delete"><i class="fas fa-trash-alt"></i></a></td>
						</tr>
					<?php } ?>
				</tbody>
			</table>
