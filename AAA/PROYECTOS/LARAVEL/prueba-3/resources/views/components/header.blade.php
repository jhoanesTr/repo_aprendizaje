    ...
    <nav class="navbar navbar-expand-md mx-md-5">
        ...
        <div class="collapse navbar-collapse py-2">
            <ul class="navbar-nav flex-row">
                <li class="nav-item">
                    <a href="{{ route('citas') }}" class="nav-link {{ request()->routeIs('citas') ? 'text-decoration-underline' : '' }}">CITAS</a>
                </li>
                <li class="nav-item">
                    <a href="{{ url('personas') }}" class="nav-link {{ request()->routeIs('personas') ? 'text-decoration-underline' : '' }}">PERSONAS</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('empresas') }}" class="nav-link {{ request()->routeIs('empresas') ? 'text-decoration-underline' : '' }}">EMPRESAS</a>
                </li>
                <li class="nav-item">
                    <a href="{{ route('informes') }}" class="nav-link {{ request()->routeIs('informes') ? 'text-decoration-underline' : '' }}">INFORMES</a>
                </li>
            </ul>
        </div>
        ...
        <ul class="navbar-nav flex-row-reverse">
            <li class="nav-item flex-row-reverse">
                ...
                <button type="submit" class="btn-secondary rounded-1 border-0 py-0 bg-gradient" >
                    <a href="{{ route('login') }}" class="text-black px-2 nav-link align-items-center">
