    ...
    <div class="container mb-4">
            ...
            <div class="container-fluid">
                ...
                <form class="d-flex" action="{{ route('empresas.index') }}" method="GET">
                    ...
                    <div class="input-group mb-3 mx-2 w-6" alt="Búsqueda de empresas">
                        <select name="buscar_por" id="filtroBusqueda">
                            <option value="">Buscar por</option>
                            <option value="">Nombre</option>
                            <option value="localidade">Localidad</option>
                            <option value="">Orientador</option>
                        </select>
                        <input name="buscar" class="form-control" type="text" placeholder="Búsqueda" aria-label="Search"
        ...
        <div id="tabla" class="row table-responsive">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    @if (is_countable($empresas) and count($empresas) <= 0)
                        <tr>
